...
class TabularDataset(Dataset):
    ...
    def load_from_csv(self, path=''):
        ...
        # Step 2: If a class column exists, put it in the end
        ...
        # Step 3: Change the name of the Dataframe columns
        self.df_.columns = [str(c) for c in range(self.num_columns)]

        # Step 4: Fit_transform the label encoders
        if self.categorical_columns is not None:
        ...
        # Step 5: Label Encode the class labels (after stripping the whitespace)
