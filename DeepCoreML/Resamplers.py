...
class TestSynthesizers:
    ...
    def __init__(self, metadata, sampling_strategy='auto', random_state=0):
        ...
        # Borderline SMOTE
        border_smote = BorderlineSMOTE(sampling_strategy=sampling_strategy,  k_neighbors=k_neighbors, random_state=random_state)

        # SMOTE with Support Vector Machine
        svm_smote = SVMSMOTE(sampling_strategy=sampling_strategy,  k_neighbors=k_neighbors, random_state=random_state)

        # A SMOTE variant brings balance to clusters identified by k-Means
        km_smote = KMeansSMOTE(sampling_strategy=sampling_strategy,  k_neighbors=k_neighbors,
                               cluster_balance_threshold='auto', random_state=random_state)

        # Adaptive Synthetic Sampling (ADASYN)
        adasyn = ADASYN(sampling_strategy=sampling_strategy, n_neighbors=k_neighbors, random_state=random_state)
        ...
        cbr = CBR(sampling_strategy=sampling_strategy, cluster_estimator='hac', cluster_resampler='cs', verbose=False,
                  k_neighbors=k_neighbors, min_distance_factor=0.01, random_state=random_state)
        ...
        sb_gan = sbGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, pac=1, epochs=epochs, batch_size=batch_size,
                       method='knn', k=k_neighbors, r=rad, sampling_strategy=sampling_strategy, random_state=random_state)
        ...
        ct_gan = CTGANSynthesizer(metadata, embedding_dim=emb_dim, discriminator_dim=disc, generator_dim=gen,
                                  pac=10, epochs=epochs, batch_size=batch_size,
                                  enforce_min_max_values=False, enforce_rounding=False, verbose=False)

        # CopulaGAN
        cop_gan = CopulaGANSynthesizer(metadata, embedding_dim=emb_dim, discriminator_dim=disc,generator_dim=gen,
                                       pac=10, epochs=epochs, batch_size=batch_size,
                                       enforce_min_max_values=False, enforce_rounding=False, verbose=False)

        # Tabular Variational Autoencoder (TVAE)
        t_vae = TVAESynthesizer(metadata,embedding_dim=emb_dim, compress_dims=disc, decompress_dims=gen,
                                epochs=epochs, batch_size=batch_size,
                                enforce_min_max_values=False, enforce_rounding=False, verbose=False)

        t_vae_128 = TVAESynthesizer(metadata, epochs=epochs, batch_size=batch_size,
                                enforce_min_max_values=False, enforce_rounding=False, verbose=False)

        # Gaussian Copula
        g_copula = GaussianCopulaSynthesizer(metadata, enforce_min_max_values=False, enforce_rounding=False)

        # CTABGAN
        ctabgan = CTABGANSynthesizer(metadata, random_dim=emb_dim, epochs=ctabgan_epochs, batch_size=batch_size,
                                     random_state=random_state)

        # CTABGAN+
        ctabgan_plus = CTABGANPlusSynthesizer(metadata, random_dim=emb_dim, epochs=ctabgan_epochs, batch_size=batch_size,
                                              random_state=random_state)
        ...
        ctdgan_hac_mms = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11',  use_classifier=True,
                           cluster_method='hac', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_hac_stds = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='stds', use_classifier=True,
                           cluster_method='hac', sampling_strategy=sampling_strategy, random_state=random_state)

        # ablation models
        ctdgan_km_mms_NoLy = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                                    batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11', use_classifier=False,
                                    cluster_method='kmeans', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_km_stds_NoLy = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='stds', use_classifier=False,
                           cluster_method='kmeans', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_kp_mms_NoLy = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11',  use_classifier=False,
                           cluster_method='kprot', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_kp_stds_NoLy = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='stds', use_classifier=False,
                           cluster_method='kprot', sampling_strategy=sampling_strategy, random_state=random_state)
        ...
        # CTD Generative Adversarial Network (ctdGAN)
        ctdgan_km_globmms = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='glob-mms11', use_classifier=True,
                           cluster_method='kmeans', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_km_globstds = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='glob-stds', use_classifier=True,
                           cluster_method='kmeans', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_kp_globmms = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='glob-mms11',  use_classifier=True,
                           cluster_method='kprot', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_kp_globstds = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='glob-stds', use_classifier=True,
                           cluster_method='kprot', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_hac_globmms = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='glob-mms11',  use_classifier=True,
                           cluster_method='hac', sampling_strategy=sampling_strategy, random_state=random_state)

        ctdgan_hac_globstds = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='glob-stds', use_classifier=True,
                           cluster_method='hac', sampling_strategy=sampling_strategy, random_state=random_state)



        ctdgan_km_mms_unisam = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11', use_classifier=True,
                           cluster_method='kmeans', sampling_strategy="unisam", random_state=random_state)

        ctdgan_km_stds_unisam = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='stds', use_classifier=True,
                           cluster_method='kmeans', sampling_strategy="unisam", random_state=random_state)

        ctdgan_kp_mms_unisam = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11',  use_classifier=True,
                           cluster_method='kprot', sampling_strategy="unisam", random_state=random_state)

        ctdgan_kp_stds_unisam = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='stds', use_classifier=True,
                           cluster_method='kprot', sampling_strategy="unisam", random_state=random_state)

        ctdgan_km_mms_balclu = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11', use_classifier=True,
                           cluster_method='kmeans', sampling_strategy="balance-clusters", random_state=random_state)

        ctdgan_km_stds_balclu = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='stds', use_classifier=True,
                           cluster_method='kmeans', sampling_strategy="balance-clusters", random_state=random_state)

        ctdgan_kp_mms_balclu = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11',  use_classifier=True,
                           cluster_method='kprot', sampling_strategy="balance-clusters", random_state=random_state)

        ctdgan_kp_stds_balclu = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                           batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='stds', use_classifier=True,
                           cluster_method='kprot', sampling_strategy="balance-clusters", random_state=random_state)
        ...
        for b in range(10):
            a_k = b / 100 + 0.01
            mdl = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11', use_classifier=True,
                cluster_method='kmeans', sampling_strategy=sampling_strategy, random_state=random_state, alpha_k=a_k)
            ctdgan_models.append(('ctdGAN_cls4clu_km_mms_' + str(b), mdl))

            mdl = ctdGAN(embedding_dim=emb_dim, discriminator=disc, generator=gen, epochs=epochs,
                batch_size=batch_size, max_clusters=max_clusters, pac=10, scaler='mms11', use_classifier=True,
                cluster_method='hac', sampling_strategy=sampling_strategy, random_state=random_state, alpha_k=a_k)
            ctdgan_models.append(('ctdGAN_cls4clu_hac_mms_' + str(b), mdl))

        # All over-samplers.
        self.over_samplers_all = [ CTResampler(mdl[0], model=mdl[1], random_state=random_state) for mdl in ctdgan_models ]
        os_filter = (0, 3, 4, 7, 8, 9, 10, 12, 13, 14, 15)
        self.over_samplers_ = [e for i, e in enumerate(self.over_samplers_all) if i in os_filter]
        #print(*self.over_samplers_)
        ...
        #self.over_samplers_ = [
            ...
            #BaseResampler(name="BorderSMOTE", model=border_smote, random_state=random_state),
            ...
            #SDVResampler(name="CTAB-GAN", model=ctabgan, random_state=random_state), # <- Do not change this name!
            ##SDVResampler(name="CTAB-GAN+", model=ctabgan_plus, random_state=random_state), # <- Do not change this name!
            #SDVResampler(name="CT-GAN", model=ct_gan, random_state=random_state),
            #SDVResampler(name="GCOP", model=g_copula, random_state=random_state),
            ...
            #SDVResampler(name="TVAE-128", model=t_vae_128, random_state=random_state),

            # ctdGAN
            #CTResampler("ctdGAN_cls4clu_km_mms", model=ctdgan_kp_mms, random_state=random_state),
            #CTResampler("ctdGAN_cls4clu_km_stds", model=ctdgan_km_stds, random_state=random_state),
            #CTResampler("ctdGAN_cls4clu_kp_mms", model=ctdgan_kp_mms, random_state=random_state),
            #CTResampler("ctdGAN_cls4clu_kp_stds", model=ctdgan_kp_stds, random_state=random_state),
            #CTResampler("ctdGAN_cls4clu_hac_mms", model=ctdgan_hac_mms, random_state=random_state),
            #CTResampler("ctdGAN_cls4clu_hac_stds", model=ctdgan_hac_stds, random_state=random_state),

            # Ablation
            #CTResampler("ctdGAN_km_globmms", model=ctdgan_km_globmms, random_state=random_state),
            #CTResampler("ctdGAN_km_globstds", model=ctdgan_km_globstds, random_state=random_state),
            #CTResampler("ctdGAN_kp_globmms", model=ctdgan_kp_globmms, random_state=random_state),
            #CTResampler("ctdGAN_kp_globstds", model=ctdgan_kp_globstds, random_state=random_state),
            #CTResampler("ctdGAN_hac_globmms", model=ctdgan_hac_globmms, random_state=random_state),
            #CTResampler("ctdGAN_hac_globstds", model=ctdgan_hac_globstds, random_state=random_state),

            #CTResampler("ctdGAN_km_mms_NoLy", model=ctdgan_km_mms_NoLy, random_state=random_state),
            #CTResampler("ctdGAN_km_stds_NoLy", model=ctdgan_km_stds_NoLy, random_state=random_state),
            #CTResampler("ctdGAN_kp_mms_NoLy", model=ctdgan_kp_mms_NoLy, random_state=random_state),
            #CTResampler("ctdGAN_kp_stds_NoLy", model=ctdgan_kp_stds_NoLy, random_state=random_state),
            ...
            #CTResampler("ctdGAN_kp_mms_balclu", model=ctdgan_kp_mms_balclu, random_state=random_state),
            #CTResampler("ctdGAN_kp_stds_balclu", model=ctdgan_kp_stds_balclu, random_state=random_state),

            #CTResampler("ctdGAN_km_mms_unisam", model=ctdgan_km_mms_unisam, random_state=random_state),
            #CTResampler("ctdGAN_km_stds_unisam", model=ctdgan_km_stds_unisam, random_state=random_state),
            #CTResampler("ctdGAN_kp_mms_unisam", model=ctdgan_kp_mms_unisam, random_state=random_state),
            #CTResampler("ctdGAN_kp_stds_unisam", model=ctdgan_kp_stds_unisam, random_state=random_state),

            #CTResampler("ctdGAN_1cluster", model=ctdgan_km_mms_1cluster, random_state=random_state),
            #CTResampler("ctdGAN_unisam", model=ctdgan_unisam, random_state=random_state),
            #CTResampler("ctdgan_km_noLu", model=ctdgan_kp_mms_1cluster, random_state=random_state),
            #CTResampler("ctdgan_kp_noLu", model=ctdgan_kp, random_state=random_state),
        ...
        self.over_samplers_sdv_ = [
            SDVResampler(name="CTGAN", model=ct_gan, random_state=random_state),
            SDVResampler(name="TVAE", model=t_vae, random_state=random_state),
            SDVResampler(name="COP-GAN", model=cop_gan, random_state=random_state),
            SDVResampler(name="GCOP", model=g_copula, random_state=random_state),
        ]
