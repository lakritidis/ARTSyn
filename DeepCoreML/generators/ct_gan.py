        ...
        if self._sampling_strategy == 'auto':
            ...
            for cls in range(self._n_classes):
                if cls != majority_class:
                    ...
                    print("\tGenerate", samples_to_generate, "samples from class: ", cls)
                    print("\tCondition column:", str(self._input_dim), "- Condition Value: ", cls)
